...
/**
 * Brute-force attack
 * @param encrypted_text: encrypted text to find 
 * @param text_lenght: lenght of text
 * @param key: key to encrypt text
 * @param threads: # of threads
 * @return
 */
void brute_force(std::string encrypted_text, int text_lenght, int **key, int threads);
